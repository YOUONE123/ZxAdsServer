...
LOCATION_DECK		=0x01		--
LOCATION_HAND		=0x02		--
LOCATION_SQUARE		=0x04		--
LOCATION_SQUARE_F	=0x08		--
LOCATION_SQUARE_E	=0x10		--
LOCATION_TRASH		=0x20		--
LOCATION_REMOVED	=0x40		--
LOCATION_FORCE		=0x80		--
LOCATION_CHARGE		=0x100		--
LOCATION_LIFE		=0x200		--
LOCATION_RESOURCE	=0x400
LOCATION_TEMPORARY	=0x800

--�X�N�G�A�A�f�b�L�]�[���A�g���b�V���A�`���[�W�A���C�t�A���\�[�X�A��D�A�e���|�����[�A�����[�u�]�[���A�t�H�[�X�]�[����
...
--Attributes
ATTRIBUTE_RED		=0x01		--
ATTRIBUTE_WHITE		=0x02		--
ATTRIBUTE_BLACK		=0x04		--
ATTRIBUTE_BLUE		=0x08		--
ATTRIBUTE_GREEN		=0x10		--
--Races
RACE_WARRIOR		=0x1		--
...
PLAYER_ALL			=3		--
--========== Reset ==========
RESET_REBOOT		=PHASE_REBOOT	--
RESET_DRAW			=PHASE_DRAW	--
RESET_RESOURCE		=PHASE_RESOURCE	--
RESET_IGNITION		=PHASE_IGNITION	--
RESET_MAIN			=PHASE_MAIN	--
RESET_END			=PHASE_END	--
...
EFFECT_TYPE_TRIGGER			=0x0080	--
EFFECT_TYPE_CONTINUOUS		=0x0800	--

--���ʂ̃I�v�V�����B�J�[�h���^�[�Q�b�g�Ɏ��A�_���[�W�X�e�b�v�ł������o����A���ʂ��R�s�[����Ȃ����B
--========== Flags ==========
...
--�R�[�h�B���ʈꗗ�݂����ȁB�U���̓A�b�v���B�i�����ʂ͂�����������B
--========== Codes ==========
...
EVENT_TO_HAND					=1012
EVENT_TO_DECK					=1013
EVENT_TO_RESOURCE				=1014
EVENT_TO_SQUARE					=1015
EVENT_TO_CHARGE					=1016
EVENT_TO_TRASH					=1017
EVENT_TO_LIFE					=1018
